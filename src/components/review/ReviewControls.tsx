    ...
    <div className="border-b bg-background" data-test-id="review-controls">
      <div className="container flex flex-col gap-4 py-4 sm:flex-row sm:items-center sm:justify-between">
        <div className="flex flex-col gap-1">
          <h1 className="text-2xl font-bold" data-test-id="review-title">Recenzja fiszek</h1>
        ...
        <Button onClick={onSave} disabled={!hasSelection || isSaving} size="lg" className="sm:w-auto w-full" data-test-id="save-flashcards-button">
