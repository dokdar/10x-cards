...
describe("SourceTextInput", () => {
  ...
  it("wyświetla komunikat o przekroczeniu maksymalnej długości", () => {
    ...
    render(<SourceTextInput {...defaultProps} value={longText} />);
  ...
  it("obsługuje różne długości minimalnej i maksymalnej", () => {
    render(<SourceTextInput {...defaultProps} minLength={500} maxLength={2000} value="test" />);
  ...
  it("snapshot test - stan błędu (za krótki tekst)", () => {
    const { container } = render(<SourceTextInput {...defaultProps} value="za krótki tekst" />);
    expect(container.firstChild).toMatchInlineSnapshot(`
      <div
        class="space-y-2"
      >
