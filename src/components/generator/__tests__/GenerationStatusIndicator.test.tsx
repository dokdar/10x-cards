...
describe('GenerationStatusIndicator', () => {
  it('nie renderuje niczego w stanie idle', () => {
    const { container } = render(
      <GenerationStatusIndicator status="idle" errorMessage={null} />
    );
  ...
  it('wyświetla komunikat błędu w stanie error', () => {
    ...
    render(
      <GenerationStatusIndicator status="error" errorMessage={errorMessage} />
    );
  ...
  it('nie wyświetla błędu gdy status to error ale brak wiadomości', () => {
    const { container } = render(
      <GenerationStatusIndicator status="error" errorMessage={null} />
    );
