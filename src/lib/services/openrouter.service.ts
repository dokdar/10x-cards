...
export class OpenRouterService {
   ...
   */
  private buildRequestPayload<T extends z.ZodTypeAny>(params: GenerationParams<T>): object {
   ...
   */
  private parseAndValidateResponse<T extends z.ZodTypeAny>(apiResponse: OpenRouterResponse, schema: T): z.infer<T> {
    ...
    try {
      ...
      if (!validationResult.success) {
        throw new ValidationError("Response validation failed.", validationResult.error.flatten().fieldErrors, {
